...
#define PLAYER_INIT_MOVE_VELOCITY 25.0f
#define PLAYER_INIT_STRAFE_VELOCITY 18.0f
#define PLAYER_INIT_ALTITUDE_ACCEL 90.0f
#define PLAYER_MAX_ALTITUDE 9.5f

#define PLAYER_FLIP_Z false

#define PLAYER_MIN_MOVE_VELOCITY 15.0f
#define PLAYER_MAX_MOVE_VELOCITY 80.0f
#define PLAYER_MIN_STRAFE_VELOCITY 10.0f
#define PLAYER_MAX_STRAFE_VELOCITY 60.0f
