...
#define GAME_PLAYER_SCALE 0.5f
#define GAME_PLAYER_INIT_ALTITUDE_ACCEL 30.0f
#define GAME_PLAYER_MAX_ALTITUDE 4.5f

#define GAME_OBSTACLE_SCALE 1.5f
#define GAME_OBSTACLE_PADDING 0.4f
#define GAME_SPAWN_SAFE_MARGIN_Z 320.0f
#define GAME_OBSTACLE_BIG_SCALE_MULTIPLIER 3.0f
